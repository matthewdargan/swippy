...
func TestFindingClient_FindItemsAdvanced(t *testing.T) {
	...
	t.Run("ResponseSuccess", func(t *testing.T) {
		...
		got, err := client.FindItemsAdvanced(params)
		if err != nil {
	...
	t.Run("HTTPNewRequestError", func(t *testing.T) {
		...
		_, err := client.FindItemsAdvanced(map[string]string{})
...
func TestFindingClient_FindItemsByCategory(t *testing.T) {
	...
	t.Run("ResponseSuccess", func(t *testing.T) {
		...
		got, err := client.FindItemsByCategory(params)
		if err != nil {
	...
	t.Run("HTTPNewRequestError", func(t *testing.T) {
		...
		client := NewFindingClient(http.DefaultClient, "ebay-app-id")
		client.URL = "http://example.com/\x00invalid"
		_, err := client.FindItemsByCategory(map[string]string{})
		if !errors.Is(err, ErrNewRequest) {
...
func TestFindingClient_FindItemsByKeywords(t *testing.T) {
	...
	t.Run("ResponseSuccess", func(t *testing.T) {
		...
		got, err := client.FindItemsByKeywords(params)
		if err != nil {
	...
	t.Run("HTTPNewRequestError", func(t *testing.T) {
		...
		client := NewFindingClient(http.DefaultClient, "ebay-app-id")
		client.URL = "http://example.com/\x00invalid"
		_, err := client.FindItemsByKeywords(map[string]string{})
		if !errors.Is(err, ErrNewRequest) {
...
func TestFindingClient_FindItemsByProduct(t *testing.T) {
	...
	t.Run("ResponseSuccess", func(t *testing.T) {
		...
		got, err := client.FindItemsByProduct(params)
		if err != nil {
	...
	t.Run("HTTPNewRequestError", func(t *testing.T) {
		...
		client := NewFindingClient(http.DefaultClient, "ebay-app-id")
		client.URL = "http://example.com/\x00invalid"
		_, err := client.FindItemsByProduct(map[string]string{})
		if !errors.Is(err, ErrNewRequest) {
...
func TestFindingClient_FindItemsInEBayStores(t *testing.T) {
	...
	t.Run("ResponseSuccess", func(t *testing.T) {
		...
		got, err := client.FindItemsInEBayStores(params)
		if err != nil {
	...
	t.Run("HTTPNewRequestError", func(t *testing.T) {
		...
		client := NewFindingClient(http.DefaultClient, "ebay-app-id")
		client.URL = "http://example.com/\x00invalid"
		_, err := client.FindItemsInEBayStores(map[string]string{})
		if !errors.Is(err, ErrNewRequest) {
